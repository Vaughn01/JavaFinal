 ...
 *
 */
public class MurderMysteryStory {
	...
	public static void MurderMystery() 
	{
		...
		JOptionPane.showMessageDialog(null, "Before she gets to touch the doorknob, the lights FLASH!!!” + And thunder sounds… You hear the sound of the principal screams..");
